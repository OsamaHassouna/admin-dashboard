...
<body id="login-page" <?php body_class(); ?>>
    <div class="container">
        <div class="row register-page-container no gutters">
        ...
        <div class="col-md-5">
            ...
            <?php
            $args = array(
            'redirect' => home_url().'/deja-user-login/',
            );
...
<?php if(get_option('users_can_register')) { ?>
        ...
        <p>You are logged in. Click <a href="<?php echo home_url('/mainBoard'); ?>">here to go Main Board</a></p>
