                ...
                <div class="row no-gutters">
                    <div class="col-12">
                        ...
                        <div class="btn-newProject">
                            <a href="<?php echo home_url('/new-task'); ?>" class="btn btn-newProject">New Task</a>
                        </div>
                    </div>
                </div>
                <!-- SECOND ROW -->
                <div class="row no-gutters">
                    <div class="col-12">
                        <ul class="tasks-list">
                            ...
                            ?>
                            <li class="task">
                                <a href="<?php the_permalink(); ?>" class="task-img">
                                    <?php if ( has_post_thumbnail() ) {the_post_thumbnail();}  ?>
                                </a>
                                <div class="task-content">
                                    <a href="<?php the_permalink(); ?>" class="task-title">
                                        <h2><?php the_title(); ?></h2>
                                    </a>
