<?php
/**
 * Template Name: page companies
 * The template for displaying Dashboard companies
 *
                ...
                <div class="row no-gutters">
                    <div class="col-12">
                        ...
                        <div class="btn-newProject">
                            <a href="<?php echo home_url('/new-company'); ?>" class="btn btn-newProject">New Company</a>
                        </div>
                    </div>
                </div>
                <!-- SECOND ROW -->
                <div class="row no-gutters">
                    <div class="col-12">
                        <ul class="companies-list">
                            ...
                            ?>
                            <li class="company">
                                <a href="<?php the_permalink(); ?>" class="company-img">
                                    <?php if ( has_post_thumbnail() ) {the_post_thumbnail();}  ?>
                                </a>
                                <div class="company-content">
                                    <a href="<?php the_permalink(); ?>" class="company-title">
                                        <h2><?php the_title(); ?></h2>
                                    </a>
